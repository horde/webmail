...
6. At least one IMAP or POP3 server.
   ...
   *client*, like Outlook, Apple Mail or Thunderbird. You must have access to
   ...
   `doc/PERFORMANCE`_ for further information).
...
5. Securing Horde Groupware Webmail Edition
   ...
   Webmail Edition, see the `doc/SECURITY`_ file.
...
trouble using a provided translation, please see the `doc/TRANSLATIONS`_
